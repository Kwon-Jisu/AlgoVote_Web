...
def extract_debate_to_txt(file_path, output_dir='./'):
    ...
    # TXT 파일로 저장
    output_path = os.path.join(output_dir, f"{formatted_date}_토론회.txt")
...
if __name__ == "__main__":
    extract_debate_to_txt('../data/broadcast03_2020.php')
