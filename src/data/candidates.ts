...
/**
 * 카테고리별 서브 카테고리 정의
 * 각 메인 카테고리에 대한 세부 카테고리 목록
 */
export const subCategories = {
  "경제": ["일자리 창출", "산업 육성", "중소기업 지원", "디지털 경제", "공정경제"],
  "교육": ["공교육 강화", "디지털 교육", "평생교육", "교육 격차 해소", "수월성 교육"],
  "복지": ["기본소득", "사회안전망", "노인복지", "아동복지", "의료복지"],
  "외교/안보": ["한미동맹", "남북관계", "외교 다변화", "국방력 강화", "평화체제"],
  "환경": ["탄소중립", "신재생에너지", "미세먼지 대책", "원전 정책", "자원순환"],
  "주거/부동산": ["주택공급", "부동산 규제", "임대주택", "재개발/재건축", "1인 가구 주거"],
  "일자리": ["청년 일자리", "노동권 강화", "노동시장 유연화", "공공일자리", "창업 지원"],
  "보건/의료": ["공공의료", "의료보장성", "감염병 대응", "디지털 헬스케어", "의료 혁신"],
  "행정": ["지방분권", "행정 효율화", "공공기관 개혁", "디지털 정부", "규제개혁"]
};
...
export const subCategoryPolicies = {
  ...
  "lee-jaemyung": {
    "경제": {
      "일자리 창출": {
        title: "공공 일자리 확대 및 청년 일자리 창출",
        content: "공공 일자리 100만개 창출 및 청년 디지털 일자리 지원 사업 확대",
        details: [
          "청년 디지털 일자리 지원금 확대 (월 200만원, 최대 6개월)",
          "AI, 빅데이터 분야 공공일자리 신설 (5만개)",
          "지역별 청년 스타트업 육성 센터 설립 (전국 17개 시도)",
          "중소기업-청년 일자리 매칭 플랫폼 구축"
        ]
      },
      "산업 육성": {
        title: "미래 신산업 육성 및 디지털 경제 활성화",
        content: "AI, 빅데이터, 로봇 등 4차 산업혁명 관련 기술 육성 및 투자 확대",
        details: [
          "디지털 뉴딜 2.0 추진 (5년간 50조원 투자)",
          "AI 산업 생태계 조성 및 전문인력 10만명 양성",
          "바이오헬스 산업 육성 (R&D 지원 확대)",
          "우주산업 육성법 제정"
        ]
      },
      "중소기업 지원": {
        title: "중소기업 혁신 지원 및 성장 촉진",
        content: "중소기업 성장 사다리 구축 및 글로벌 경쟁력 강화",
        details: [
          "중소기업 R&D 지원 확대 (GDP 대비 1.5%)",
          "글로벌 강소기업 육성 (5년간 1,000개 기업)",
          "중소기업 디지털 전환 세액공제 확대",
          "가업승계 세제 지원 확대"
        ]
      },
      "디지털 경제": {
        title: "디지털 경제 전환 가속화 및 데이터 경제 활성화",
        content: "AI, 빅데이터 중심의 디지털 경제로 전환 지원",
        details: [
          "데이터 3법 개정을 통한 데이터 활용 확대",
          "AI 기반 공공서비스 혁신",
          "클라우드 퍼스트 정책 도입",
          "블록체인 기반 디지털 자산 생태계 조성"
        ]
      },
      "공정경제": {
        title: "경제민주화 및 공정경제 강화",
        content: "대기업-중소기업 상생협력 강화 및 불공정 거래 근절",
        details: [
          "하도급 불공정 행위 처벌 강화",
          "납품단가 연동제 도입",
          "중소기업 기술 탈취 방지 특별법 제정",
          "플랫폼 노동자 권리 보호 강화"
        ]
      }
    },
    "교육": {
      "공교육 강화": {
        title: "공교육 경쟁력 강화 및 학교 환경 개선",
        content: "공교육 투자 확대 및 교사 역량 강화로 공교육 신뢰 회복",
        details: [
          "학급당 학생 수 20명 이하로 감축",
          "교원 행정업무 경감 및 교육 전념 환경 조성",
          "노후 학교시설 현대화 (5년간 10조원 투자)",
          "학교 비정규직 처우 개선"
        ]
      },
      "디지털 교육": {
        title: "디지털 교육 혁신 및 AI 교육 강화",
        content: "모든 학생의 디지털 역량 강화 및 AI 기반 교육 혁신",
        details: [
          "초중고 소프트웨어·AI 교육 필수화",
          "메타버스 기반 교육 플랫폼 구축",
          "교사 디지털 역량 인증제 도입",
  ...
  "kim-moonsoo": {
    "경제": {
      "일자리 창출": {
        title: "기업 중심 일자리 창출 및 규제 완화",
        content: "기업 투자 활성화를 통한 양질의 일자리 창출 지원",
        details: [
          "기업 신규 채용 인센티브 확대 (사회보험료 지원)",
          "규제 샌드박스 전 산업 확대",
          "법인세 단계적 인하 (22%에서 17%로)",
          "신산업 분야 규제 신속확인제 도입"
        ]
      },
      "산업 육성": {
        title: "주력 산업 경쟁력 강화 및 미래 산업 육성",
        content: "반도체, 배터리, 자동차 등 주력 산업 지원 및 육성",
        details: [
          "반도체 특별법 제정 및 세제 지원 확대",
          "배터리 산업 R&D 투자 확대 (5년간 5조원)",
          "자율주행차 규제 완화 및 실증단지 조성",
          "방산 수출 지원 및 우주산업 육성"
        ]
      },
      "중소기업 지원": {
    ...
    "교육": {
      "수월성 교육": {
        title: "수월성 교육 강화 및 영재교육 확대",
        content: "우수 인재 양성을 위한 특성화 교육 및 영재교육 지원",
        details: [
          "영재학교 및 과학고 확대 및 지원 강화",
          "대학 자율성 보장 및 경쟁력 강화",
          "STEM 교육 강화 및 관련 인프라 확충",
          "학생 선택권 확대 및 맞춤형 교육과정 운영"
        ]
      },
      "평생교육": {
        title: "직업교육 강화 및 평생학습 체계 구축",
        content: "산업수요 맞춤형 직업교육 및 성인 재교육 시스템 구축",
        details: [
          "마이스터고 확대 및 지원 강화",
          "산학협력 중심 대학 특성화",
          "성인 재교육 바우처 제도 도입",
  ...
  "lee-junseok": {
    "경제": {
      "일자리 창출": {
        title: "청년 중심 혁신 일자리 창출",
        content: "스타트업 생태계 활성화 및 청년 일자리 지원 확대",
        details: [
          "청년 창업자 법인세 5년간 면제",
          "스타트업 규제 특례 지역 지정 (전국 10곳)",
          "청년 창업 지원금 확대 (최대 5천만원)",
          "기술창업 멘토링 시스템 구축"
        ]
      },
      "디지털 경제": {
        title: "디지털 전환 가속화 및 데이터 경제 활성화",
        content: "AI, 빅데이터 중심의 디지털 경제로 전환 지원",
        details: [
          "데이터 3법 개정을 통한 데이터 활용 확대",
          "AI 기반 공공서비스 혁신",
      ...
      "산업 육성": {
        title: "미래 산업 투자 확대 및 규제 혁신",
        content: "메타버스, 바이오, 우주산업 등 신산업 집중 육성",
        details: [
          "메타버스 산업 육성 (5년간 5조원 투자)",
          "바이오헬스 규제 혁신 및 R&D 지원",
          "우주산업 육성법 제정",
          "신산업 규제 샌드박스 전면 도입"
        ]
      }
    ...
    "교육": {
      ...
      "평생교육": {
        title: "미래 역량 중심 평생교육 체계 구축",
        content: "디지털 전환 시대 평생학습 및 직업 전환 지원",
        details: [
          "K-MOOC 플랫폼 확대 및 콘텐츠 강화",
          "평생교육 바우처 지원 확대 (연간 100만원)",
          "직업전환 교육 프로그램 개발 및 지원",
          "마이크로 디그리 도입 및 활성화"
        ]
      }
    }
